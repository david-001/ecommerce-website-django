...
SECRET_KEY = 'django-insecure-+$r=nn9!ntx+v6+z7)o$zcuz)k6aa7-f69cnrrqm#8b(be#4!1'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'ecommerce/static/media'
...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER')  # enter your gmail address
